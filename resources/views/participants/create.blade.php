...
<div class="page-header">
    <div>
        <h2>Participantes</h2>
        <div class="subtitle">Preencha as informações necessárias para cadastrar participantes.</div>
    </div>
</div>
...
<form method="POST" action="{{ route('participants.store') }}">
    ...
    <div class="form-grid">
        ...
        <div>
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="Nome do Participante" required>
            </div>
    ...
    <div class="form-actions">
        <a href="{{ route('participants') }}" class="btn btn-ghost">CANCELAR</a>
